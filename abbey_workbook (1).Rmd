...
sum(balt_homicides_arrests$arrests) / sum(balt_homicides_arrests$total)
...
#this code failed. I dont understand why you are using the sf package to create a ggplot.
...
balt_homicides_sf <- balt_homicides %>% 
    ...
    coords = c("lon","lat"),
    crs="NAD83") %>%
  geom_sf(data = homicide_data, aes(color = "disposition")) +
